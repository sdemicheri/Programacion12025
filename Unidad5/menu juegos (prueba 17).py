try:
 ...
 if( J == 1 ):
   ...
   elif(puntos == 2 and usuario_advinando1 <= 2 and usuario_advinando2 <= 2 or usuario_advinando2 <= 2 and usuario_advinando3 <= 2 or usuario_advinando1 <= 2 and usuario_advinando3 <= 2 ):
     print("")
   ...
   elif(puntos == 1 and usuario_advinando1 <= 2 or usuario_advinando2 <= 2 or usuario_advinando3 <= 2):
     print("")
